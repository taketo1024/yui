...
fn k9_46() {
    ...
    for ver in [SsVersion::V1, SsVersion::V2] {
...
fn interlock_9_46() {
    ...
    assert_eq!(ssi_invariant_with(&l, false, config, None, SsVersion::V2), (0, 4));
}
...
fn wh_pretzel_3() {
    ...
    let ssi = ssi_invariant_with(&w, false, wh_pretzel_config(17), Some(2), SsVersion::V2);
    assert_eq!(ssi, (0, 2));
}
...
fn wh_pretzel_5() {
    ...
    let w = InvLink::whitehead_double(&k, true, 0);
    let ssi = ssi_invariant_with(&w, false, wh_pretzel_config(20), Some(2), SsVersion::V2);
