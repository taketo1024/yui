...
fn time_us(l: &Link, mode: DeloopMode, reps: usize) -> f64 {
    let cfg = BuildConfig { deloop_mode: mode, ..Default::default() };
...
fn main() {
    ...
    for name in ["3_1", "5_1", "6_3", "8_19", "14n_19265"] {
        ...
        let g = time_us(&l, DeloopMode::Greedy, reps);
        let s = time_us(&l, DeloopMode::Selective, reps);
